...
namespace COMP2139_Labs.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            var profilePicture = user.ProfilePic;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if(user.UserNameChangeLimit > 0) { 
                if(Input.Username!=user.UserName) {
                    var userNameExist= _userManager.FindByNameAsync(Input.Username);  
                    if(userNameExist !=null)
                    {
                        StatusMessage = "Error:username not available. Please Enter a new name:";
                    }
